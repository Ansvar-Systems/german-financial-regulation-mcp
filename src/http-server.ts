...
const TOOLS = [
  {
    ...
    description:
      "Volltextsuche in BaFin-Rundschreiben und Mindestanforderungen (MaRisk, BAIT, VAIT, KAIT, MaComp, MaGo).",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Suchbegriff" },
        sourcebook: { type: "string", description: "Filter nach Rundschreiben-ID (z.B. MARISK, BAIT). Optional." },
        status: {
          type: "string",
          enum: ["in_force", "deleted", "not_yet_in_force"],
          description: "Filter nach Status. Optional.",
        },
        limit: { type: "number", description: "Maximale Ergebnisanzahl (Standard 20)." },
      },
      required: ["query"],
    },
  },
  {
    ...
    description:
      "Ruft eine BaFin-Vorschrift anhand von Rundschreiben und Referenz ab (z.B. MaRisk AT 7.2).",
    inputSchema: {
      type: "object" as const,
      properties: {
        sourcebook: { type: "string", description: "Rundschreiben-Kennung (z.B. MARISK, BAIT, VAIT)" },
        reference: { type: "string", description: "Vorschriftreferenz (z.B. 'AT 7.2', 'Abschnitt 3.1')" },
      },
  ...
  },
  {
    ...
    description: "Listet alle BaFin-Rundschreiben und Mindestanforderungen mit Namen und Beschreibungen.",
    inputSchema: { type: "object" as const, properties: {}, required: [] },
  },
  {
    name: "de_fin_search_enforcement",
    description:
      "Suche in BaFin-Massnahmen -- Bussgeldentscheidungen, Untersagungen und Anordnungen.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Suchbegriff (Firmenname, Verstossart usw.)" },
        action_type: {
          type: "string",
  ...
  },
  {
    ...
    description: "Pruft ob eine BaFin-Vorschrift aktuell in Kraft ist.",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "Vorschriftreferenz (z.B. 'AT 7.2')" },
      },
      required: ["reference"],
    },
  },
      ...
      switch (name) {
        ...
        case "de_fin_about": {
          return textContent({
            ...
            version: pkgVersion,
            description:
              "BaFin (Bundesanstalt fuer Finanzdienstleistungsaufsicht) MCP-Server. Bietet Zugang zu BaFin-Rundschreiben: MaRisk, BAIT, VAIT, KAIT, MaComp, MaGo, WpHG-Rundschreiben sowie Aufsichtsmassnahmen.",
